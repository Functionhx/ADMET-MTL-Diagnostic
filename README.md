...
| 4 | **Not task-specific label transfer** | Fully permuted auxiliary labels leave the gain intact under both protocols (random Δ = +0.290 vs +0.300; scaffold +0.441 vs +0.407); the protocol interaction **survives permutation** (Γ_permuted = +0.112 vs Γ_real = +0.096); pooled pretrain + STL fine-tune retains only +0.036 → the gain lives in *joint optimization of the shared representation* |
